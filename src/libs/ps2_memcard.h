#ifndef PS2_MEMCARD_H
#define PS2_MEMCARD_H

#include <stdbool.h>
#include <stdint.h>

#define PS2_SAVE_PATH "WIPEOUT" // the 0 is replaced later
...
#define MAX_PORTS 2
#define ICN_FILE "wipeout.icn"

#ifdef PS2_MEMCARD_IMPLEMENTATION
...
// TODO: load from disk
unsigned int size_ps2_icon_data = 0;
unsigned char ps2_icon_data = 0;
...
static inline bool create_save(void) {
    ...
    strcpy_sjis((short *)&icon_sys.title, "Wipeout");
...
#endif // PS2_MEMCARD_IMPLEMENTATION
